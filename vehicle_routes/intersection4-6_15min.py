...
vehicle_counts = {
    'intersection1': {'bicycle': 40, 'bus': 0, 'car': 320, 'motorcycle': 1111, 'truck': 24, 'traditional_jeepney': 91, 'modern_jeepney': 13},
    'intersection2': {'bicycle': 22, 'bus': 0, 'car': 198, 'motorcycle': 311, 'truck': 18, 'traditional_jeepney': 63, 'modern_jeepney': 15},
    'intersection3': {'bicycle': 50, 'bus': 13, 'car': 470, 'motorcycle': 827, 'truck': 39, 'traditional_jeepney': 51, 'modern_jeepney': 9},
}
...
tree.write("vehicle_routes/randomRoutes4-6.xml", pretty_print=True, xml_declaration=True, encoding='UTF-8')

jeepney_tree = etree.ElementTree(jeepney_trips_xml)
jeepney_tree.write("vehicle_routes/jeepneyTrips4-6.rou.xml", pretty_print=True, xml_declaration=True, encoding='UTF-8')
