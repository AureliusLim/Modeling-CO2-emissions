...
full_route = [
    ...
    "-29377703#1", "-29377703#0", "-1069829005#2" , "-1069829005#1", "1069829005#1", "1069829005#2" , "29377703#0"
]
...
# Parse the XML file
filename = "Passenger_replicate/person_flows_trad11-1.rou.xml"
...
if mode in [1, 2, 3]:
    ...
    if mode == 1:
        configFile = "configs/dashval1.sumo.cfg"
    elif mode == 2:
        configFile = "configs/dashval2.sumo.cfg"
    elif mode == 3:
        configFile = "configs/dashval3.sumo.cfg"
